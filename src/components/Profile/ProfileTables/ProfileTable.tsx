...
export const ProfileTable: FC = () => {
    ...
    const [table16, setTable16] = useState<string>('Racine');
    const [table17, setTable17] = useState<string>('Clifford chance');
    const [table18, setTable18] = useState<string>('SVZ');
        ...
        <Wrapper>
            ...
            <Table>
                ...
                <tr>
                        ...
                        <td>
                            <StyledTextInput type='text' value={table16} onChange={e => setTable16(e.target.value)} />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <StyledTextInput type='text' value={table17} onChange={e => setTable17(e.target.value)} />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <StyledTextInput type='text' value={table18} onChange={e => setTable18(e.target.value)} />
                        </td>
                    </tr>
                </TableBody>
            </Table>
